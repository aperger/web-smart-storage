...
2. Set application title/branding to **WebSmartStorage**.
3. Enable PWA support (Angular service worker) and verify production build artifacts.
4. Keep framework defaults; avoid heavy global CSS overrides.
