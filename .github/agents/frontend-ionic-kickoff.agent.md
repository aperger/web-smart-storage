...
| 2026-09-15 | @klm96551 + Copilot | **DOCUMENTATION UPDATED**: Clarified modern Angular 22 + Ionic 9 best practices. All components must be standalone (standalone: true), import Ionic components directly from @ionic/angular. No NgModule-based component declarations. Updated agent, skill, and README docs. Commit: 296ecfd. FE-02 implementation needs refactoring to use standalone pattern. |